...
class FilterController extends GetxController {
  ...
  final initialDateController = DatePickerItemController(null);
  final finalDateController = DatePickerItemController(null);
  final fieldController = CustomDropdownButtonController('');
